...
export default function CardFlip({
  title = 'OnCore AI Platform',
  subtitle = 'Intelligent healthcare solutions',
  description = 'Advanced AI-powered healthcare platform designed to enhance patient care and streamline medical workflows.',
  features = [
    'AI Diagnostics',
    'Smart Scheduling',
    'Patient Analytics',
      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center pt-8">
            {image ? (
              <div className="relative w-full h-48 overflow-hidden rounded-lg mx-4">
                <img 
                  src={image} 
                  alt={title}
